...
async function Header() {
  ...
  return (
    <header className='w-5/6 relative mx-auto container my-4 bg-white lg:px-4 rounded-md flex justify-between items-center shadow-custom_shadow drop-shadow-md'>
