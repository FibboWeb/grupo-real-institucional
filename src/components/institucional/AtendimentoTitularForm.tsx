...
import { z } from "zod";
import "./atendimento-titular-form.css";

export function AtendimentoTitularForm() {
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2 text-fb_text_gray">
            ...
            <div>
              ...
              <label htmlFor="eliminar">
                Gostaria solicitar a anonimização, o bloqueio ou eliminação dos meus Dados;
              </label>
            </div>
            <div>
              <input
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            className="border border-[#c1c1c1] p-2 rounded-xl"
            type="text"
            id="nome"
            name="nome"
            required
        ...
        <button
          content="Enviar"
          type="submit"
          className="mx-auto btn-submit py-2 px-4 bg-fb_blue_button text-white rounded-lg w-fit"
        >
