...
const CURSOS_TESES = `<p>15 cursos frequentados (dois no exterior):</p>
<ul>
...
export function claudioMartinsFallbackSections(): LandingSection[] {
  return [
    {
      type: "hero",
      titulo: "Professor Doutor",
      tituloLinha2: "Claudio Martins Real",
    ...
    },
    {
      ...
      cards: [
        {
          icone: "/certified-clean.svg",
          titulo: "I. Presidente da Academia Sul-mato-grossense de Medicina Veterinária",
          texto: "<p>Empossado Primeiro Presidente da Academia Sul-mato-grossense de Medicina Veterinária - 2018</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“II. Professor Emérito” da UFRGS",
          texto:
        ...
        {
          icone: "/certified-clean.svg",
          titulo: "“III. Cidadão Campo-grandense”",
          texto:
        ...
        {
          icone: "/certified-clean.svg",
          titulo: "“IV. Personalidade Descendente”",
          texto:
        ...
        {
          icone: "/certified-clean.svg",
          titulo: "“V. Relevantes Serviços”",
          texto: "<p>Título concedido pela Sociedade de Veterinária do Distrito Federal – 1998.</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“VI. Relevantes Serviços”",
          texto: "<p>Título concedido pela SOVERGS. Sociedade de Veterinária do Rio Grande do Sul – 1999</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“VII. Precursor da Homeopatia Veterinária Brasileira”",
          texto:
            "<p>Título outorgado pela ABMVH. Associação Brasileira dos Médicos veterinários Homeopatas. SP – 2000.</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“VIII. Sócio Honorário”",
          texto: "<p>Título concedido pela Sociedade de Medicina Veterinária do Rio Grande do Sul, SOVERGS – 2005.</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“IX. Membro Honorário”",
          texto: "<p>Título concedido pela Academia de Medicina Veterinária do Rio Grande do Sul – 2007.</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“X. Comenda do Mérito Veterinário” no grau de Comendador.",
          texto: "<p>Título concedido pela Sociedade Brasileira de Medicina Veterinária – 2007.</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“XI. Prêmio Paulo Dacorso Filho”",
          texto:
            "<p>Maior distinção a ser concedida para um Med. Veterinário. O Prêmio foi concedido pelo Conselho Federal de Medicina Veterinária – 2007</p>",
        },
        {
          icone: "/certified-clean.svg",
          titulo: "“XII. Grã Cruz do Mérito Veterinário Brasileiro”",
          texto: "<p>Título concedido pela Sociedade Brasileira de Medicina Veterinária – 2010</p>",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      conteudo: ATIVIDADES_DOCENTES,
      imagem: Claudio4,
      inverterDesktop: true,
      lerMais: true,
      centralizarBotao: true,
    },
    {
      type: "accordion",
...
export function claudioMartinsFallback(): LandingPageContent {
  return { secoes: claudioMartinsFallbackSections() };
}
