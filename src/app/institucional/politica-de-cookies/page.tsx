        ...
        <div className="flex flex-col gap-fb_space-section">
            ...
            <div className="flex flex-col gap-4 text-[#333333]">
                <div className="flex flex-col gap-2">
                    <p>Para garantir que o nosso website funcione adequadamente e possa fornecer uma experiência agradável, utilizamos cookies, assim como a maioria dos websites.</p>
                    <p>Você poderá escolher quais tipos de cookies deseja consentir ao navegar em nosso site, através das configurações de privacidade.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="text-xl font-semibold text-fb_blue_main">1. O que são Cookies?</h2>
                    <p>Um cookie é um pequeno arquivo de computador enviado por um site para o navegador do usuário quando este visita o site. Ele armazena informações como credenciais de login, itens do carrinho de compras, entre outros.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="text-xl font-semibold text-fb_blue_main">2. Categorias de Cookies</h2>

                    <h3 className="text-lg font-medium text-fb_blue_main ml-2">2.1. De acordo com a Responsabilidade pela Gestão</h3>
                    <ul className="flex flex-col gap-3 ml-2">
                        <li><strong>Cookies Próprios:</strong> Definidos diretamente pelo site visitado.</li>
                        <li><strong>Cookies de Terceiros:</strong> Criados por domínios diferentes do site acessado.</li>
                    </ul>
                    ...
                    <ul className="flex flex-col gap-3 ml-2">
                        ...
                        <li><strong>Cookies Não Necessários:</strong> Sua desativação não impede a navegação.</li>
                    </ul>

                    <h3 className="text-lg font-medium text-fb_blue_main ml-2">2.3. De acordo com a Finalidade</h3>
                    <ul className="flex flex-col gap-3 ml-2">
                        <li><strong>Cookies Analíticos:</strong> Acompanham o desempenho do site.</li>
                        <li><strong>Cookies de Funcionalidade:</strong> Armazenam preferências do usuário.</li>
                        <li><strong>Cookies de Publicidade:</strong> Exibem anúncios personalizados.</li>
                    </ul>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p>A coleta de dados por meio de cookies pode ser amparada pela Lei Geral de Proteção de Dados (LGPD), com base no consentimento do usuário ou no legítimo interesse.</p>
                </div>
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p>Você pode gerenciar os cookies nas configurações do seu navegador ou em dispositivos móveis. Também é possível ativar a opção { "Não Rastrear" }.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="text-xl font-semibold text-fb_blue_main">6. Atualização do Aviso de Cookies</h2>
                    <p>Este aviso pode ser alterado para garantir conformidade com a LGPD. Sempre informaremos sobre mudanças e versões atualizadas.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="text-xl font-semibold text-fb_blue_main">7. Dúvidas</h2>
                    <p>Se tiver dúvidas, entre em contato pelo e-mail <a href="mailto:lgpd@realh.com.br">lgpd@realh.com.br</a>.</p>
                </div>
                <div className="flex flex-col gap-2">
