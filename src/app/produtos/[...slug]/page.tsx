  ...
  const mock = [
    {
      ...
      long_descricao: "Oferece tecnologia 3D (sincronismo de proteína e energia no rúmen, por meio da degradação de proteína).",
      imagem: {
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 fb_container gap-8'>
          ...
          <div className='mx-auto flex flex-col gap-2'>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div>
              <Button
                className="w-full lg:w-auto h-12 px-10 bg-fb_green hover:bg-green-700"
              >
                <Link 
              ...
              <div className='flex flex-col gap-4'>
                ...
                <div>
                  ...
                  >
                      <p>
                        Produto de pronto uso que deve estar sempre disponível no cocho, devendo ser fornecido puro aos animais; Consumo é estimado em 60 g/100 Kg/ Peso corporal (PC).
                      </p>
                  </Accordion>
                  <Accordion 
                    title="Indicações"
