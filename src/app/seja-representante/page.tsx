  ...
  return (
    <div className=" from-blue-950 to-blue-900">
      ...
      <main>
        {/* Forms Section */}
        <div className="">
          <HeroSection heroCssExtra={"pt-10 md:pt-20 lg:pt-32 bg-top"} cssExtra={"mt-12"} backgroundClass={"bg-seja-representante"} imageMaxHeight={580} imageOnBottom={true} boxShadow={"bg-[rgba(3,29,58,0.85)]"}>
