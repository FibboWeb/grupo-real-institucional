...
$cursosTeses = <<<'HTML'
<p>15 cursos frequentados (dois no exterior):</p>
<ul>
...
$iconCertified = 'asset:icons/certified-clean.svg';
$iconDog = 'asset:icons/dog.svg';
$iconDegree = 'asset:icons/degree.svg';
$iconCertifiedAlt = 'asset:icons/certified.svg';
...
return [
    ...
    'description' => 'Currículo do Professor Doutor Claudio Martins Real — hero, biografias, títulos, diplomas, distinções e newsletter.',
    'yoast' => [
    ...
    'secoes' => [
        ...
        [
            ...
            'conteudo' => '<p>O professor Doutor Claudio Martins Real nasceu em 11 de fevereiro de 1926, no município de Capão do Leão, na época, 4º Distrito de Pelotas. Formou-se em Medicina Veterinária na Escola de Agronomia e Medicina da UFRGS. Com 24 anos, tornou-se o Professor Catedrático mais jovem do País.</p>',
        ...
        [
            ...
            'conteudo' => '<p>Por influência do pai, Francisco Real, tornou-se defensor e estudioso da Homeopatia, quebrando paradigma ao usar a terapêutica em rebanhos pela primeira vez. Foi, portanto, o precursor e criador do termo Homeopatia Populacional.</p>',
        ...
        [
            ...
            'conteudo' => '<p>Trabalhou como professor até 1993, quando, após aposentar-se, fundou, junto com os filhos, o Grupo Real. Até hoje o professor dedica-se com entusiasmo ao estudo da Homeopatia e da Medicina Veterinária.</p>',
        ...
        [
            ...
            'titulo' => 'Diplomas',
            'intro' => '<p>O Professor Doutor Claudio Martins Real acumulou ao longo de sua trajetória acadêmica e profissional uma coleção notável de diplomas e reconhecimentos. Formado em Medicina Veterinária pela UFRGS, destacou-se por sua dedicação à pesquisa e ao ensino, além de ter sido o Professor Catedrático mais jovem do Brasil.</p>',
            'itens' => [
        ...
        [
            ...
            'itens' => [
                [
                    ...
                    'conteudo' => '<p>da Faculdade de Agronomia e Veterinária da UFRGS e por turmas de Formandos da UFMS.</p><ul><li>UFRGS - 1959, 54, 56, 61, 62, 63, 73, 75 e 76.</li><li>UFMS - 1985 e 1986.</li></ul>',
                    'aberto' => 1,
                ],
                [
                    'titulo' => '03 vezes Homenageado de Honra da turma de formandos do Curso de Veterinária',
                    'conteudo' => '<p>da Faculdade de Agronomia e Veterinária da UFRGS e por turmas de Formandos da UFMS.</p><ul><li>UFRGS - 1979.</li><li>UFMS - 1982 e 1993.</li></ul>',
                    'aberto' => 0,
                ],
                [
                    'titulo' => '10 vezes Paraninfo de turma de formandos do Curso de Veterinária',
                    'conteudo' => '<p>da Faculdade de Agronomia e Veterinária da UFRGS.</p><ul><li>UFRGS - 1951, 53,64, 65, 66, 67, 69, 70, 72, 74.</li></ul>',
                    'aberto' => 0,
                ],
            ],
        ],
        ...
        [
            ...
            'conteudo' => '<ul><li>106 participações em Congressos Nacionais;</li><li>05 participações em Congressos Internacionais;</li><li>34 trabalhos Originais Publicados, sobre: Clínica Médica, Clínica da Reprodução, Manejo, e em Terapêutica Homeopática, sendo dois em ”L\'homeopathie Française”. Paris - 1954 e 1955.</li></ul>',
